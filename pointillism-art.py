...
def create_pointillism_art(image_path, num_points=50000, min_size=1, max_size=50):
    # Load image
...
# Create pointillism art from the ZTM logo
create_pointillism_art('./example/ztm-logo.png', num_points=50000, min_size=1, max_size=30)