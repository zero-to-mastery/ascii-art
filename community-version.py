...
Example:
1. For grayscale ASCII art:
python community-version.py example/ztm-logo.png --width 120

2. For colored ASCII art:
python community-version.py example/ztm-logo.png --color

This will generate ASCII art based on the specified options and save it as a text or HTML file.
"""
...
This will start a local web server, and you can open your browser to the URL shown in the terminal (usually http://localhost:8501) to access the app.
